...
/// A bottom sheet for adding a new task.
/// Returns an [AddTaskFormData] if the user successfully creates a task.
class AddTaskBottomSheet extends StatefulWidget {
  const AddTaskBottomSheet({super.key});

  /// Displays the bottom sheet and returns the captured form data.
  static Future<AddTaskFormData?> show(BuildContext context) {
                  ...
                  Row(
                    children: [
                      ...
                      Expanded(
                        child: PrimaryButton(
                          label: 'Create Task',
                          // Button is disabled if title is empty or too long
